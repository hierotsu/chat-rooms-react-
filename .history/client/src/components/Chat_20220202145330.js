    ...
    return <div className={"chat-window" + (isReduced ? ' isReduced' : '')}>
        <div className="chat-header" onClick={reduceChat}>
            ...
            <div className="action-bar">
                {isLogged ? <button className="toggle-users" onClick={showUserPanel}><i className="fas fa-users"></i></button>
                <button className="close-chat" onClick={logout}><i className="fas fa-times"></i></button>
                    : <button className="login-chat" onClick={login}><i className="fas fa-times"></i>Login</button>
                }
            </div>
        </div>
